                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Container(
                      child: Obx(
                        () {
                          if (controller.responseData.isEmpty) {
                            return const Center(
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                Color circleColor = getCircleColor(item.idValidacion);
                                return Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(item.descripcion, style:const TextStyle(fontSize: 14.0, color: Colors.grey),),
                                    ],
                                  ),
                                );
                              },
                            ...
                            children: [
                              Column(
                                ...
                                children: controller.responseDataDia.map((itemdia) {
                                  Color circleColordia = getCircleColor(itemdia.idValidacion);
                                  return Row(
                                    children: [
                                      Container(
                                        width: 20, 
                              ...
                              Column(
                                ...
                                children: controller.responseDataDia.map((itemdia) {
                                  return Column(
                                    ...
                                    children: [
                                      const SizedBox(width: 10.0,),
                                       Text(itemdia.tipoMarcacion, style: const
                              ...
                              Column(
                                ...
                                children: controller.responseDataMes.map((itemmes) {
                                  return Column(
                                    ...
                                    children: [
                                      const SizedBox(width: 10.0,),
                                       Text('$itemmes.cantidad', style: const
                                        TextStyle(color: Color.fromRGBO(38, 52, 113, 1),
                                        fontWeight: FontWeight.bold,
                                        fontSize: 18,),),
                                      Text(itemmes.descripcion,style: 
                                        TextStyle(color: Colors.grey,
                                        fontSize: 13,),),
                                    ],
                                  );
