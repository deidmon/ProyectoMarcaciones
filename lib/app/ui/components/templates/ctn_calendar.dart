          ...
          child: Container(
            ...
            child: SfDateRangePicker(
              ...
              headerStyle: const DateRangePickerHeaderStyle(
                ...
                view: DateRangePickerView.month, // Asegúrate de especificar la vista que deseas usar
                monthViewSettings:const DateRangePickerMonthViewSettings(
                  viewHeaderStyle: DateRangePickerViewHeaderStyle(
                    textStyle: TextStyle(
                      color: Colors.grey, // Cambia el color del texto de los días aquí
                    ),
                  ),
              ...
              DateRangePickerCellDetails cellDetails) {
                ...
                if (currentDate.year == today.year &&
                  ...
                  cellColor =const Color.fromRGBO(38, 52, 113, 1); // Resaltar el día de hoy
                }
                return Row(//borrar el row si esta muy desentrado
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style:const TextStyle(
                                      color: Colors.grey, // Cambia el color del texto de la fecha a blanco
                          ),
                        ),
                      ),
                    ),
